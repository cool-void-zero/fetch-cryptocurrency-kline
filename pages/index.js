...
export default function Home(){
  ...
  */
  ...
  const [indicator_config, setIndicatorConfig] = useState(
    indicatorsEnum
      .filter(indicator => 
        ["SMA", "EMA", "RSI"].includes(indicator.short_name)
      )
      .map(indicator => ({
  ...
  return (
    <>
      ...
      <main className="container mx-auto p-4">
       {/* Button Group: Configs */}
       <div className="btn-group" role="group" aria-label="Config setting of toggle button group">
        {/* Button: Symbol Config */}
        <input id="btn-symbol-config" type="checkbox" className="btn-check" defaultChecked
          data-bs-toggle="collapse" data-bs-target="#symbol-config" aria-expanded="true" 
        />
        <label htmlFor="btn-symbol-config" className="btn btn-outline-primary">
          Symbol Config
        </label>
        
        {/* Button: Indicators Config */}
        <input id="btn-indicator-config" type="checkbox" className="btn-check" 
          data-bs-toggle="collapse" data-bs-target="#indicator-config" 
          aria-expanded="false" aria-controls="collapseWidthExample"
        />
        <label htmlFor="btn-indicator-config" className="btn ms-2 btn-outline-primary">
          Indicators Config
        </label>
       </div>
       {/* End of Button Group: Configs */}
       
       {/* Section: Symbol Config */}
       <div id="symbol-config" 
        className="collapse show visible flex flex-wrap w-full  items-center justify-center">
